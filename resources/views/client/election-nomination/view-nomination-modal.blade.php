    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="candidateListModalLabel">Nomination Details</h5>
            ...
            <div class="modal-body">
                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            <th scope="row" class="fw-bold">Candidate Description</th>
                            <td><span id="viewCandidateDescription" class="form-control-static"></span></td>
                        </tr>
                        <tr>
                            <th scope="row" class="fw-bold">Candidate Hostel Name</th>
                            <td><span id="viewCandidateHsotelName" class="form-control-static"></span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><span id="viewElectionSeat" class="form-control-static"></span></td>
                        </tr>
                        <tr>
                            <th scope="row" class="fw-bold">Referal</th>
                            <td><span id="viewCandidateReferal" class="form-control-static"></span></td>
                        </tr>
                        <tr>
                            <th scope="row" class="fw-bold">Stars</th>
                            <td><span id="viewCandidateStars" class="form-control-static"></span></td>
                        </tr>
                        <tr>
...
<script>
    $(document).ready(function () {
        ...
        function resetFields(){
            $("#viewCandidateCnic").text('');
            $("#viewCandidateMobileNo").text('');
            $("#viewCandidateCountryName").text('');
            $("#viewCandidateStateName").text('');
            $("#viewCandidateCityName").text('');
            $("#viewCandidateAddress").text('');
            $("#viewCandidateDescription").text('');
