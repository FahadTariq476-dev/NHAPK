            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Edit Membership Types</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Edit Membership Types</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container" style="color: black;">
                        <form class="blog-form" id="membershipTypesFrom" action="{{route('admin.membership.membershipTypes.updateMembershipTypes')}}" method="POST">
                          ...
                          <div class="form-group mb-1">
                            ...
                            <input type="text" class="form-control" id="description" name="description" value="{{$membershipTypes->description}}" maxlength="65535" placeholder="Enter a description here" autofocus>
                          </div>
                          @error('description')
                            <div class="alert alert-danger">{{$message}}</div>
                          @enderror
                          ...
                          <div class="form-group mb-1">
                            ...
                            <select class="form-control" id="membershipRoleId" name="membershipRoleId" autofocus>
                              <option  value="" selected disabled>Select Role of a Membership</option>
                              @if (count($roles)>0)
                                @foreach ($roles as $role)
                                  <option value="{{$role->id}}" @if ($membershipTypes->role_id==$role->id) selected @endif>{{$role->name}}</option>
                                @endforeach
                              @else
