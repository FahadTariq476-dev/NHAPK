                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Post Referral Level
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Post Referral Level</h4>
                    </div>
                    <div class="card-body">
                        <div class="card-text">
                            <div class="mb-2">
                                <!-- formReferralLevel -->
                                <form action="{{ route('admin.referralLevels.saveReferralLevel') }}" method="POST" id="formReferralLevel">
                                    @csrf
                                    <!-- Title -->
                                    <div class="form-group">
                                        <label>Title:</label>
                                        <input type="text" id="title" name="title" class="form-control" value="{{old('title')}}" placeholder="Enter Title of Referral Level Here:" minlength="3" maxlength="255" autofocus />
                                    </div>
                                    @error('title')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="description" name="description" class="form-control" placeholder="Enter Description of Referral Level Here:" minlength="3" maxlength="255" autofocus>{{old('description')}}</textarea>
                                    </div>
                                    @error('description')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <div class="form-group mb-1">
                                        <label>Number:</label>
                                        <input type="number" id="number" name="number" value="{{old('number')}}" class="form-control" placeholder="Enter Number of Referral Level Here:" autofocus />
                                    </div>
                                    @error('number')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <div class="form-group mb-1">
                                        ...
                                        <input type="number" id="percentage" name="percentage" value="{{old('percentage')}}" class="form-control" placeholder="Enter Percentage of Referral Level Here:" autofocus />
                                    </div>
                                    @error('percentage')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
