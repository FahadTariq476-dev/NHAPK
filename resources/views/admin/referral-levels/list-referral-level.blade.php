                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin.referralLevels.postReferralLevel')}}">Referral Level</a>
                                    </li>
                                    <li class="breadcrumb-item active">List Referral Level
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">List Referral Level</h4>
                    </div>
                    <div class="card-body">
                        <div class="card-text">
                            <div class="mb-2">
                                <!-- Begin: Data Table for Listing User -->
                                <table class="table mb-0 dataTable" id="nhapkReferralLevelTable" style="background-color: #f2f2f2; color: #333;">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Title</th>
...
@section('js')
    ...
    <script>
        ...
        jq(document).ready(function() {
            var dataTable = jq('#nhapkReferralLevelTable').DataTable({
                columns: [
                    { data: 'id' },
                    { data: 'title' },
                    { data: 'description'},
                ...
                ajax: {
                    url: "/admin/referral-levels/list",
                    type: "GET",
                    data: function(d) {
            ...
            // Event delegation for dynamically generated elements
                jq('#nhapkReferralLevelTable').on('click', '.btnChangeStatus', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            jq.ajax({
                                url: '/admin/referral-levels/list/change/status/' + dataId,
                                type: 'get',
            ...
            jq('#nhapkReferralLevelTable').on('click', '.edit-btn', function() {
                var dataId = jq(this).data('id');
                Swal.fire({
                    title: "Are you sure?",
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href = '/admin/referral-levels/list/edit/' + dataId;
                    } else {
            ...
            jq('#nhapkReferralLevelTable').on('click', '.delete-btn', function() {
                var dataId = jq(this).data('id');
                ...
                Swal.fire({
                    ...
                    confirmButtonText: 'Yes, delete it!'
                        ...
                        if (result.isConfirmed) {
                            ...
                            jq.ajax({
                                url: '/admin/referral-levels/list/delete/' + dataId,
                                type: 'get',
                                success: function(response) {
                                    dataTable.ajax.reload();
                                    if (response.status == 'error') {
