            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Add Complaint Types</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin.complaint-types.list')}}">Complaint Types</a>
                                    </li>
                                    <li class="breadcrumb-item active">Add Complaint Types</li>
                                </ol>
                            </div>
                        </div>
                    </div>
