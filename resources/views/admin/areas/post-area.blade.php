                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Post Area</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="card-text">
                            <div class="mb-2">
                                <!-- form Add Area -->
                                <form action="{{route('admin.areas.store')}}" method="POST" id="formStoreAreas">
                                    @csrf
                                    <!-- Select Country -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="areaTitle" name="areaTitle" value="{{old('areaTitle')}}" class="form-control" placeholder="Enter Your Area Title Here:">
                                    </div>
                                    @error('areaTitle')
                                        <div class="alert alert-danger">{{$message}}</div>
                                    @enderror
