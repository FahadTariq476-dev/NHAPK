                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="/" class="brand-logo">
                                    ...
                                    <h2 class="brand-text text-primary ms-1">NHAPK</h2>
                                </a>
                                ...
                                <form class="auth-login-form mt-2" method="POST" action="{{route('front-end.client.login_credentials')}}"  id="loginForm">
                                    @csrf
                                    @if (session('error'))
