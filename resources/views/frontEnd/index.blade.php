            ...
            <nav data-aos="zoom-out" data-aos-delay="800" class="navbar navbar-expand">
                <div class="container header">
                    ...
                    <a class="navbar-brand" href="/">
                        <img class="navbar-brand-regular" src="assets/img/logo/NHAPK.JPEG" alt="brand-logo" style="width:50px">
                        <img class="navbar-brand-sticky" src="assets/img/logo/NHAPK.JPEG" alt="sticky brand-logo">
                    </a>
                    ...
                    <ul class="navbar-nav action">
                        <li class="nav-item ml-3">
                            <a href="{{route('ContactUsForm')}}" class="btn ml-lg-auto btn-bordered-white"><i class="fas fa-paper-plane contact-icon mr-md-2"></i>Contact Us</a>
                        </li>
                    </ul>
                </div>
            </nav>
