...
(function(l) {
    ...
    function T(a, b, c, d) {
        ...
        if (k === q)
            return a.iDrawError != e && null === g && (da(a, 0, "Requested unknown parameter " + ("function" == typeof h.mData ? "{function}" : "'" + h.mData + "'") + " for row " + b + ", column " + c, 4),
            a.iDrawError = e),
            g;
    ...
    function wa(a, b, c, d) {
        ...
        if ("dom" !== c && (c && "auto" !== c || "dom" !== e.src)) {
            ...
            e._aData = bb(a, e, d, d === q ? q : e._aData).data;
        e._aSortData = null;
        e._aFilterData = null;
        f = a.aoColumns;
        if (d !== q)
        ...
        for (c = a.aoData.length; h < c; h++) {
            ...
            if (!f._aFilterData) {
                ...
                for (d = b.length; e < d; e++) {
                    ...
                    k.indexOf && -1 !== k.indexOf("&") && (Qa.innerHTML = k,
    ...
    function Ra(a, b, c) {
        ...
        0 > d && (d = 0)) : "next" == b ? d + e < h && (d += e) : "last" == b ? d = Math.floor((h - 1) / e) * e : da(a, 0, "Unknown paging action: " + b, 5);
    ...
    function Ha(a) {
        ...
        if (a.scrollBarVis !== fa && a.scrollBarVis !== q)
            ...
            Math.round(w.outerWidth()) < Math.round(h) ? (la = g.scrollHeight > g.offsetHeight || "scroll" == n.css("overflow-y") ? h + b : h,
            L && (g.scrollHeight > g.offsetHeight || "scroll" == n.css("overflow-y")) && (C.width = K(la - b)),
            "" !== c && "" === d || da(a, 1, "Possible column misalignment", 6)) : la = "100%";
            p.width = K(la);
            f.width = K(la);
    ...
    function Za(a) {
        ...
        for (v = 0; v < k.length; v++) {
            var w = c[k[v]];
            null !== w.sWidth && (w.sWidth = Zb(w.sWidthOrig, p),
            t = !0)
        }
    ...
    function pb(a, b, c) {
        ...
        if (b && b.time) {
            ...
            0 < f && b.time < +new Date - 1E3 * f)
                ...
                a.iInitDisplayStart = b.start) : Ra(a, b.start / b.length));
    ...
    function Da(a, b) {
        var c = ec.numbers_length
          , d = Math.floor(c / 2);
        b <= c ? a = ra(0, b) : a <= d ? (a = ra(0, c - 2),
        a.push("ellipsis"),
        a.push(b - 1)) : (a >= b - 1 - d ? a = ra(b - (c - 2), b) : (a = ra(a - d + 2, a + d - 1),
        a.push("ellipsis"),
        a.push(b - 1)),
    ...
    var u = function(a, b) {
        ...
        this.each(function() {
            ...
            if ("table" != this.nodeName.toLowerCase())
                ...
                f = function() {
                    ...
                    xa(r.aoFooter, r.nTFoot));
                    if (g.aaData)
                        for (k = 0; k < g.aaData.length; k++)
                            ia(r, g.aaData[k]);
                    else
                        (r.bDeferLoading || "dom" == Q(r)) && Ja(r, l(r.nTBody).children("tr"));
        ...
        c = null;
        return this
    }, M, y, J, sb = {}, gc = /[\r\n\u2028]/g, Va = /<.*?>/g, uc = /^\d{2,4}[\.\/\-]\d{1,2}[\.\/\-]\d{1,2}([T ]{1}\d{1,2}[:\.]\d{2}([\.:]\d{2})?)?$/, vc = /(\/|\.|\*|\+|\?|\||\(|\)|\[|\]|\{|\}|\\|\$|\^|\-)/g, rb = /['\u00A0,$£€¥%\u2009\u202F\u20BD\u20a9\u20BArfkɃΞ]/gi, Z = function(a) {
        return a && !0 !== a && "-" !== a ? !1 : !0
    }, hc = function(a) {
        var b = parseInt(a, 10);
    ...
    y("destroy()", function(a) {
        ...
        return this.iterator("table", function(b) {
            ...
            e != f.parentNode && (k.children("thead").detach(),
            k.append(f));
            g && e != g.parentNode && (k.children("tfoot").detach(),
            k.append(g));
            b.aaSorting = [];
            b.aaSortingFixed = [];
            Sa(b);
            ...
            (p = b.asDestroyStripes.length) && h.children().each(function(t) {
